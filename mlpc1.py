...
classifier = MLPClassifier(hidden_layer_sizes=(5,), activation='logistic',
...
print('MLPC percentage prediction on the first test set is:',predictions)
testSet = [[4,3,3,4,5,2,5,5]]
test = pd.DataFrame(testSet)
predictions = classifier.predict(test)
print('MLPC percentage prediction on the second test set is:',predictions)
testSet = [[1,2,3,5,3,4,2,4]]
test = pd.DataFrame(testSet)
predictions = classifier.predict(test)
print('MLPC percentage prediction on the third test set is:',predictions)
